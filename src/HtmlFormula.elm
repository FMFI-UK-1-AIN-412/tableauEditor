module HtmlFormula exposing (htmlFormula, htmlParen, htmlSigned, htmlVar, joinMapA)
...
joinMapA glue fa xs acc =
    case xs of
        ...
        y :: ys ->
            fa y (List.foldr (\z facc -> glue :: fa z facc) acc ys)


htmlSigned sf =
    case sf of
        T f ->
            strong [] [ text "T" ] :: text " " :: htmlFormula f []

        F f ->
            strong [] [ text "F" ] :: text " " :: htmlFormula f []
