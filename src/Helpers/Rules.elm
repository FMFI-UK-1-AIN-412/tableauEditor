...
import Html exposing (Attribute, Html, div, h2, h3, p, table, td, text, tr, sub, sup, span)
...
symbolsTable =
    div [ class "half" ]
        ...
        , Html.table [ class "rulesHelpTable" ]
            ...
            , Html.tr []
                [ Html.td [] [ text "unary" ]
                , Html.td [ colspan 2 ] [ text "binary, takes two terms" ]
                , Html.td [ colspan 4 ]
    ...
    div [ class "full" ]
        ...
        , Html.table [ class "rulesHelpTable" ]
            ...
            , Html.tr []
                ...
                , Html.td [] [table [ class "rule", class "withWhiteSpace" ] <|
